...
public class Pagar {
    ...
    public Pagar(int id, Date dataEmissao, float valorEmitido, Date dataVencimento, Date dataPagamento, float valorDesconto, float valorAcrescimo, float valorPago, String observacao, boolean status) {
        this.id = id;
