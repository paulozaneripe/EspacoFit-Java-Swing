...
public class TelaBuscaProduto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanelTitulo.setBackground(new java.awt.Color(152, 155, 57));
        jPanelTitulo.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanelTitulo.setPreferredSize(new java.awt.Dimension(544, 50));

        jLabelFornecedores.setBackground(new java.awt.Color(0, 0, 0));
        jLabelFornecedores.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabelFornecedores.setForeground(new java.awt.Color(255, 255, 255));
        jLabelFornecedores.setText("Produtos");
        ...
        jPanelBotoesLayout.setVerticalGroup(
            ...
            .addGroup(jPanelBotoesLayout.createSequentialGroup()
                .addGroup(jPanelBotoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jBotaoSair, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Descrição", "und. Compra", "und. Venda", "correlacao Und.", "Valor", "Qtd. Estoque", "Código de Barra", "Observação"
            }
        ) {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(2).setMinWidth(91);
            jTable1.getColumnModel().getColumn(2).setMaxWidth(91);
            jTable1.getColumnModel().getColumn(3).setMinWidth(83);
            jTable1.getColumnModel().getColumn(3).setMaxWidth(83);
            ...
            jTable1.getColumnModel().getColumn(6).setMinWidth(95);
            jTable1.getColumnModel().getColumn(6).setMaxWidth(95);
            jTable1.getColumnModel().getColumn(7).setMinWidth(135);
            jTable1.getColumnModel().getColumn(7).setPreferredWidth(135);
            jTable1.getColumnModel().getColumn(7).setMaxWidth(135);
